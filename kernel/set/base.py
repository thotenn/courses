"""
Django settings for quieroestudiar project.
...
SECRET_KEY = 'django-insecure-3ex6y1_jip!-tc-h^y-*&d$*(cwu3sioft@$$u_3l_x_ju^3w6'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_PROJECT, 'templates'),
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_PROJECT, '')
